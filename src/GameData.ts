...
export enum FeatureRequirementType {
...
export enum ParametersEventName {
...
export interface GenericData {
    ...
    tiers?:                        TierElement[] | { [key: string]: TierValue };
    ...
    interactables?:                { [key: string]: InteractableValue };
    frequency?:                    string;
    locationIDs?:                  string[];
...
export enum PurpleClipName {
    ButtonDisabled = "button-disabled",
    Play = "play",
    Pop = "pop",
}

export enum ComparisonFunction {
    ComparisonFunction = ">=",
    Empty = "===",
}
...
export enum CompleteBgColor {
    A7E34E = "#A7E34E",
    The2E573A = "#2E573A",
}

export enum OnFinishedPropertyName {
    Active = "active",
    Color = "color",
...
export enum DefaultTriggerData {
    Empty = "",
    Map = "map",
    Zone = "zone",
}
...
export enum FluffyClipName {
    Break = "break",
    ButtonDisabled = "button-disabled",
    Pop = "pop",
}

export enum PurpleFont {
    ABeeZee = "ABeeZee",
    AbeeZee = "AbeeZee",
    PaytoneOne = "Paytone One",
}
...
export enum TentacledShadowColor {
    The425Bbd = "#425BBD",
    The683510 = "#683510",
}
...
export interface CunningComponent {
    guid?:           string;
    properties:      { [key: string]: Array<PurpleProperty | number | string> | boolean | FluffyProperty | number | null | string };
    type?:           string;
    tuid?:           string;
    collapsed?:      boolean;
    editorMetadata?: EditorMetadata;
...
export interface MagentaComponent {
    guid?:           string;
    properties?:     { [key: string]: Array<TentacledProperty | number | string> | boolean | StickyProperty | number | null | string };
    type?:           string;
    tuid?:           string;
    collapsed?:      boolean;
    editorMetadata?: EditorMetadata;
...
export enum PurplePropertyName {
    Active = "active",
    Color = "color",
    Empty = "",
    InputEnabled = "inputEnabled",
...
export interface PrefabComponent {
    guid?:      string;
    properties: { [key: string]: Array<IndigoProperty | number | string> | boolean | IndecentProperty | number | null | string };
    type?:      string;
    collapsed?: boolean;
    tuid?:      string;
    name?:      string;
...
export enum KnockbackEase {
    CircularOut = "circularOut",
}

export enum ReturnEase {
    ExponentialOut = "exponentialOut",
}

export enum PurpleAnimation {
    Animation = "animation",
    Attack = "attack",
...
export enum FluffyPropertyName {
    Active = "active",
    InputEnabled = "inputEnabled",
