...
var tokenify = function (username, password, _a, online) {
    var _b = _a === void 0 ? {} : _a, log = _b.log;
    if (online === void 0) { online = false; }
    return __awaiter(void 0, void 0, void 0, function () {
        var cookiefetch, lastCookie_1, url, _c, formSite, site, dom, document, authenticity, loginParams, login, playLoginParams, _d, _e, _f, _g, _h, schoolLogin, playLogin, clientId, tokenParams, tokenLogin, secondTokenLogin, tokenProp, tokenInit, master, masterJson;
        var _j, _k, _l, _m, _o;
        return __generator(this, function (_p) {
            switch (_p.label) {
                case 0:
                    if (online) {
                        lastCookie_1 = "";
                        cookiefetch = function (url, options) { return __awaiter(void 0, void 0, void 0, function () {
                            var res, res;
                            var _a, _b;
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    case 0:
                                        if (!lastCookie_1) return [3, 2];
                                        return [4, window.fetch(url, __assign(__assign({}, options), { headers: __assign(__assign({}, options === null || options === void 0 ? void 0 : options.headers), { cookie: lastCookie_1 }) }))];
                                    case 1:
                                        res = _c.sent();
                                        lastCookie_1 = (_a = res.headers.get("set-cookie")) !== null && _a !== void 0 ? _a : "";
                                        return [2, res];
                                    case 2: return [4, window.fetch(url, options)];
                                    case 3:
                                        res = _c.sent();
                                        lastCookie_1 = (_b = res.headers.get("set-cookie")) !== null && _b !== void 0 ? _b : "";
                                        return [2, res];
                                }
                            });
                        }); };
                ...
                case 4:
                    ...
                    playLoginParams = new url_1.URLSearchParams();
                ...
                case 6:
                    ...
                    return [4, cookiefetch("https://sso.prodigygame.com/premises?premises=home&rid=" + new URL(login.headers.get("location") || "").searchParams.get("rid"), { headers: { "content-type": "application/x-www-form-urlencoded" }, body: playLoginParams.toString(), method: "POST", redirect: "manual" })];
                case 7:
                    schoolLogin = _p.sent();
                ...
                case 9:
                    clientId = (_o = (_p.sent()).match(/var client_id = '([0-9a-f]+)';/)) === null || _o === void 0 ? void 0 : _o[1];
