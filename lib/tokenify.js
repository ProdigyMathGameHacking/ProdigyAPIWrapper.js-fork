        ...
        return __generator(this, function (_p) {
            switch (_p.label) {
                ...
                case 6:
                    ...
                    return [4, cookiefetch("https://sso.prodigygame.com/premises?premises=home&rid=".concat(new url_1.URL(login.headers.get("location") || "").searchParams.get("rid")), { headers: { "content-type": "application/x-www-form-urlencoded" }, body: playLoginParams.toString(), method: "POST", redirect: "manual" })];
                case 7:
                    schoolLogin = _p.sent();
                ...
                case 11:
                    ...
                    if (!secondTokenLogin.ok && !secondTokenLogin.status.toString().startsWith("3"))
                        throw new Error("Second authentication request failed with a code of ".concat(secondTokenLogin.status, "."));
                    if (log)
                        console.log("Second token request done with a code of ".concat(secondTokenLogin.status, "."));
                    ...
                    return [4, (0, node_fetch_1.default)("https://api.prodigygame.com/game-auth-api/v4/user", {
                            headers: {
